...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Background */}
      <div className="fixed inset-0 bg-linear-to-br from-blue-950 via-black to-purple-950 animate-gradient"></div>
      <div className="fixed inset-0 opacity-30 animate-pulse-slow">
        <div className="absolute inset-0 bg-linear-to-tr from-purple-900/40 via-transparent to-blue-900/40"></div>
      </div>
      ...
      >
        ...
        <div className="max-w-md w-full relative z-10 flex flex-col items-center">
          ...
          {/* Title - Diperkecil dan tetap di tengah */}
